      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Users login details.</p>
...
$sql='SELECT * FROM userlog ORDER By time DESC LIMIT ' . $results_per_page . ' OFFSET ' . $this_page_first_result;
$result = mysqli_query($conn, $sql);
...
<?php for ($page=1;$page<=$number_of_pages;$page++) {
  echo '<li class="page-item"><a class="page-link" href="userlog.php?page=' . $page . '">' . $page . '</a></li>';
}    
                 ?></ul>
                </div> </div>
