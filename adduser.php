...
VALUES ('$uname', '$pswh')";
        ...
        if ($conn->query($sql) === TRUE) {
             ...
             $msg='<div class="alert alert-success">
              <strong>Success!</strong> Added user to the system.
            </div>';
            } 
            else {
                
             $msg='<div class="alert alert-danger">
              <strong>Invalid!</strong> Something went wrong.
            </div>';
}}
?>
<!DOCTYPE html>
      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Adding non admin users to website.</p>
...
?>
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="adduser.php" method="post" enctype="multipart/form-data">
              ...
              <button class="btn btn-primary text-uppercase" type="submit" name="submit">Add</button>
